        ...
        <h2 class="text-center">{{ tenancy()->tenant->system_info['general']['title'] }}</h3>
            ...
            <h3 class="text-center"><u>ADMISSION FORM</u></h4>
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td class="bottom-border text-uppercase">@{{ student.name }}
                                </td>
                            </tr>
                            <tr>
                                <th>Father's Name</th>
                                <td class="bottom-border text-uppercase">@{{ student.father_name }}
                                </td>
                            </tr>
                            <tr>
                                <th>Address</th>
                ...
                <div class="pull-right col-xs-3" style="border: 1px solid black; height: 200px">
                    <p style="font-size: 15px; width: 100%; margin-top: 80px" class="text-center">
                        Photo</p>
                </div>
                    ...
                    <table class="table">
                        <tbody>
                            <tr>
                                ...
                                <td colspan="2" class="bottom-border" width="60%">
                                    @{{ student.father_name }}
                                    @{{ "(" + student.guardian_relation + ")" }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2" class="bottom-border">@{{ student.last_school }}
                                </td>
                            </tr>
                            <tr>
                                <th colspan="2">Seeking Admission in Class</th>
                                <td colspan="2" class="bottom-border">@{{ student.seeking_Class }}
                                </td>
                            </tr>
                        </tbody>
                    </table>
                ...
                <table width="100%" style="margin-top: 100px">
                    <tbody>
                        <tr>
                            <th width="35%" style="border-bottom: 1px solid; padding-top: 2px">
                                Date:</th>
                            <th width="30%"></th>
                            <th width="35%" class="text-center" style="border-top: 1px solid; padding-top: 2px">
                                Signature of Parent/Guardian</th>
                        </tr>
                    </tbody>
                </table>
                <h3 class="text-center" style="border-top: 1px solid; padding-top: 8px">FOR OFFICE
                    USE</h3>
                <table class="table">
                    <tbody>
                        <tr>
                        ...
                        <tr>
                            ...
                            <th>Class</th>
                            <td class="bottom-border">@{{ student.std_class.name }}
...
<div class="footer" style="border: none;">
    <table width="100%">
        <tbody>
            <tr>
                <th width="35%" class="text-center" style="border-top: 1px solid; padding-top: 5px">Signature of
                    Principal</th>
                <th width="30%"></th>
                <th width="35%" class="text-center" style="border-top: 1px solid; padding-top: 5px">Signature
                    of Accountant</th>
            </tr>
        </tbody>
    </table>
    ...
    <div class="row">
        ...
        <div>
            Software Developed By <strong> HASHMANAGEMENT.COM © {{ now()->year }} </strong>
        </div>
    </div>
</div>
